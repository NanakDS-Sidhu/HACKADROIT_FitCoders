        ...
        <div className="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl
          ...
          <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
            <div className="relative">
              ...
              <input placeholder="Enter Email" type="text" onChange={(e) => setFormData({...formData, email: e.target.value})} value={formData.email} className="border placeholder-gray-400 focus:outline-none
            ...
            <div className="relative">
              <a className="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-indigo-500
                  rounded-lg transition duration-200 hover:bg-indigo-600 ease" onClick={login}>Submit</a>
            </div>
          </div>
        </div>
